...
import { Dashboard, NotFound ,Tasks,TaskDetails } from 'frontend/pages';
...
export const protectedRoutes = [
  {
    ...
    children: [
      ...
      { path: '*', element: <NotFound /> },
          { path: 'accounts/:accountId/tasks', element: <Tasks /> },
              { path: 'accounts/:accountId/tasks/:taskId', element: <TaskDetails /> },
    ],
  },
];
